...
Klikkaa **Select by Expression**- työkaluikonia QGISissä. Valitse kaikki liikuntakohteet, jotka kuuluvat kotikuntasi alueella, ja jotka voisivat kiinnostaa sinua. Tallenna valitut kohteet uudeksi erilliseksi karttatasoksi.
...
-   käytä `ìn` operaattoria ja listaa liikuntapaikan tyypit
